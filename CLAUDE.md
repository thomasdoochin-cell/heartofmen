...
- **Nav & socials:** the hamburger menu (`nav.js`) lists Living Leadership, Full Circle Fund, then an external **"Free, Live Masterclass"** (Luma: `https://luma.com/vi68x32g`, new tab), then Instagram. The footer `.footer-social` row has **Instagram** + **Substack** (`https://heartofmen.substack.com/`) icon links.
